...
layout = go.Layout(
    title=f"MUMPS MMR vaccination coverage max(1st or 2nd Dose) vs reported case incidence rate for different countries<br>{slope_text} {year_range_text}",
    ...
    annotations=[
        ...
        dict(
            ...
            yref='paper',
            # case incidence rate per 1M
            text='case incidence rate -> https://immunizationdata.who.int/global/wiise-detail-page/mumps-reported-cases-and-incidence?GROUP=Countries&YEAR=' + 
                 '<br>vac coverage -> https://immunizationdata.who.int/global/wiise-detail-page/measles-vaccination-coverage?CODE=ISR&ANTIGEN=MCV2&YEAR=',  # Text content
...
fig.write_html(fr"C:\MUMPS-max1D-or-2D\B) MUMPS {slope_text} {year_range_text}.html")
