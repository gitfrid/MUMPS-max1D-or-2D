...
layout = go.Layout(
    title='Mumps vaccination coverage max(1st or 2nd Dose) vs reported case incidence rate for different countries',
...
fig.write_html(fr"C:\MUMPS-max1D-or-2D\A) MUMPS vaccination_vs_reported_cases {year_range_text}.html")
